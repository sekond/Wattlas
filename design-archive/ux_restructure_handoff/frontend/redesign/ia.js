  ...
  pages: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { h: "Curated, not live", p: "A few figures are hand-assembled from published studies and carried as committed static tables with a range and a citation — the France cost stack, the storage-capacity series and the marginal-fuel inputs. They are labelled as estimates and take no side. Full per-figure sourcing lives in <code>SOURCES.md</code>." },
      ],
    },
    {
      id: "privacy",
