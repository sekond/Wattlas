// Wattlas Mobile — builds the 8 panel sections (same ids the v2 renderers target).
"use strict";
...
const PANEL_DEFS = [
  ...
  { id: "spread", k: "2 · Spread — the daily gap", tip: "tb1",
    ...
    body: '<div class="chartwrap" id="boxSpread"><canvas id="cSpread"></canvas></div><div class="statrow" id="statsSpread"></div><p class="cap" id="capSpread"></p>',
    story: "storySpread" },
  ...
  { id: "carbon", k: "6 · Carbon — how clean each hour is", tip: "carbon",
    ...
    body: '<div class="chartwrap" id="boxCarbon"><canvas id="cCarbon"></canvas></div><div class="statrow" id="statsCarbon"></div><p class="cap" id="capCarbon"></p>',
    story: "storyCarbon" },
...
document.getElementById("panels").innerHTML = PANEL_DEFS.map((p) =>
  '<section class="panel" id="' + p.id + '" data-screen-label="' + p.k + '">' +
