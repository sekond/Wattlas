...
> them untouched. The Value-Layer plan lives in `ROADMAP_V10.md` +
> `prompts/v10_prompts.md`.

Companion input: `wattlas-consolidated-roadmap.md` (the conclusions to review).
Sibling runbooks you must stay consistent with: `RUN.md`, `RUN_V2.md`,
`ROADMAP_V2.md`. Domain rules live in `CLAUDE.md` — they override anything here
if they conflict.
...
2. **Produce** a concrete, sequenced implementation plan (`ROADMAP_V10.md` +
...
Write `ROADMAP_V10.md` (mirror `ROADMAP_V2.md`) and `prompts/v10_prompts.md`
...
- `ROADMAP_V10.md` and `prompts/v10_prompts.md` exist and are internally
